...
ALIYUN_CAPTCHA_ACCESS_KEY_ID="${ALIYUN_CAPTCHA_ACCESS_KEY_ID:-}"
ALIYUN_CAPTCHA_ACCESS_KEY_SECRET="${ALIYUN_CAPTCHA_ACCESS_KEY_SECRET:-}"
...
FIRST_PARTY_ACCESS_TOKEN_TTL_SECONDS="${FIRST_PARTY_ACCESS_TOKEN_TTL_SECONDS:-43200}"
FIRST_PARTY_REMEMBERED_ACCESS_TOKEN_TTL_SECONDS="${FIRST_PARTY_REMEMBERED_ACCESS_TOKEN_TTL_SECONDS:-259200}"
...
FIRST_PARTY_ACCESS_TOKEN_TTL_SECONDS=$FIRST_PARTY_ACCESS_TOKEN_TTL_SECONDS
FIRST_PARTY_REMEMBERED_ACCESS_TOKEN_TTL_SECONDS=$FIRST_PARTY_REMEMBERED_ACCESS_TOKEN_TTL_SECONDS
